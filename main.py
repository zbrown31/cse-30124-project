...
ride_backup_filepath = "/Users/zachbrown/Desktop/Work/Desi/Tech/Code/firebase_backups/backup_10_30_23.json"
...
strategies: list[tuple[type, dict[str, Hashable]]] = [(BaseStrategy, {}),(GreedyStrategy, {}), (HungarianStrategy,{}), (BatchedGreedyStrategy, {'batch_time' : 12}), (BatchedHungarianStrategy, {'batch_time' : 12})]
...
#The first element is the type of the strategy
#The second element is a dictionary mapping the name to the value of each keyword parameter passed to the strategy constructor
strategies: list[tuple[type, dict[str,Hashable]]] = [(BatchedGreedyStrategy, {}), (BatchedHungarianStrategy, {})]
...
output = experiment.run(
   strategies , min_batch_size, max_batch_size, num_drivers
)
experiment.display()
